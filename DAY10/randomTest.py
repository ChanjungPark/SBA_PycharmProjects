...
print('표준 편차가 1, 평균이 0인 정규분포에서 표본 추출')
...
# 0, 1, 2 중에서 임의로 하나를 추출하는 동작을 5번 수행하여 나온 수의 총합을 구해보세요.
# 예시) 0 1 1 1 2 = 5
...
# 시드 배정은 동일한 데이터를 샘플링하거나 머신러닝시 동일한 결과를 한시적으로 추출해보고자 할 때 사용합니다.
# seed = 100
# np.random.seed(seed)   # 랜덤값에 시드 배정

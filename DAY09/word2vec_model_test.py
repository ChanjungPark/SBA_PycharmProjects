...
# 이전에 만들어둔 모델 파일을 읽어 와서 특정 단어와 유사한 단어를 찾아봅니다.
# 인접한 유사도를 이용하여 데이터를 시각화 해봅니다.
...
# most_similar : positive에 명시된 단어에 대하여 유사도가 높은 항목을 topn개만 보여주세요.
